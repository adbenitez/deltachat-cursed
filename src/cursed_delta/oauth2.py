...
def get_authz_code(ac, addr, port,
    ...
    if success_message is None:
        success_message = "The authorization code was received. You may close this window."

    auth_url = get_oauth2_url(ac, addr, f'http://127.0.0.1:{port}/')

    wsgi_app = _RedirectWSGIApp(success_message)
    local_server = wsgiref.simple_server.make_server(
        '127.0.0.1', port, wsgi_app
    )
    ...
    assert 'code' in res_params and res_params['code'], "authorization code not found in url"
